...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 21 2022 г., 14:35
...
INSERT INTO `products` (`id`, `description`, `price`, `discount`, `image`) VALUES
(1, 'на звонки ST', 5, '50%', '/assets/image/phone.svg'),
(2, 'за спецкурс', 10, '30%', '/assets/image/book.svg'),
(3, 'за курс', 20, '50%', '/assets/image/books.svg'),
(4, 'за курс', 25, '65%', '/assets/image/books.svg');
